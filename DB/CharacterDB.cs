                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                AtkCount = 1,
                                Ratio = 100,
                                Effect = "악성 채무[100%][피격 4회] — 방어력 감소 20%·물리 취약 17%(각 최대 2중첩), 보스 제외 (미모델)"
                                } },
                            { 1, new SkillLevelData {
                                TargetCount = 1,
                                AtkCount = 1,
                                Ratio = 130,
                                Effect = "악성 채무[100%][피격 4회] (미모델)"
                                } },
                            { 2, new SkillLevelData {
                                TargetCount = 1,
                                AtkCount = 1,
                                Ratio = 145,
                                Effect = "각성: 물리 145%. 악성 채무[100%][피격 4회] (미모델)"
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 3, Debuff = new DebuffSet { Eff_Hit_Red = 18 } }
                                },
                                Effect = "관통, 효과 적용 확률 감소 18%[100%][3턴], 악성 채무 (미모델)"
                                } },
                            { 1, new SkillLevelData {
                                TargetCount = 4,
                                AtkCount = 2,
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 3, Debuff = new DebuffSet { Eff_Hit_Red = 24 } }
                                },
                                Effect = "강화: 효과 적용 확률 감소 24%"
                                } },
                            { 2, new SkillLevelData {
                                TargetCount = 4,
                                AtkCount = 2,
                                ...
                                Effect = "각성: 물리 72%. 관통, 효과 적용 확률 감소 24%[100%][3턴], 악성 채무 (미모델)"
                                } }
                        },
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffTurnReduction, Chance = 100, TurnReduction = 2, PreDamage = true }
                                },
                                Effect = "대상의 턴제 버프 2턴 감소[100%]"
                                } },
                            { 1, new SkillLevelData {
                                TargetCount = 4,
                                AtkCount = 2,
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Effect = "각성: 물리 90%. 대상의 턴제 버프 2턴 감소[100%]"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Cooldown = 0,
                                Ratio = 72,
                                Bonus = new BuffSet { CriBonusDmg = 60, CriBonusDmgPerHit = true },
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffTurnReduction, Chance = 100, TurnReduction = 2, PreDamage = true }
                                },
                                Effect = "[각성 게이지 145, 미모델] 모든 적군 물리 72% 2회. 대상 턴제 버프 2턴 감소[100%]. 치명타 발생 시 각 공격마다 물리 60% 추가 피해"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                ...
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        { 0, new PassiveLevelData {
                            Effect = "자신: 모든 피해 면역[2턴], 사망 시 불사로 부활[2턴](전투당 1회). 모든 아군: 효과 적중 28% 증가[상시]. 아군(공격형·자신 제외): 스킬 2회 발동 시 불공정 계약(위치별 효과). 피해 면역·불공정 계약 미모델",
                            Effects = new List<PersistentEffect>
                            {
                                ...
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ImmortalTurns = 2, OncePerBattle = true } }
                            }
                        }},
                        { 1, new PassiveLevelData {
                            Effect = "강화: 불사 부활[3턴], 효과 적중 34% 증가",
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect { Target = EffectTarget.Party, Type = PersistentEffectType.Buff, Buff = new BuffSet { Eff_Hit = 34 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ImmortalTurns = 3, OncePerBattle = true } }
                            }
                        }},
                        { 2, new PassiveLevelData {
                            Effect = "각성: 모든 피해 면역[2턴], 사망 시 불사로 부활[3턴](전투당 1회), 불사 발동 시 각성 게이지 +40. 모든 아군: 효과 적중 34% 증가[상시]. 아군(공격형·자신 제외): 스킬 2회 발동 시 불공정 계약(후열 물공+25%[2턴]·피해 무효화 리필 등). 피해 면역·불공정 계약·각성 게이지 미모델",
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect { Target = EffectTarget.Party, Type = PersistentEffectType.Buff, Buff = new BuffSet { Eff_Hit = 34 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ImmortalTurns = 3, OncePerBattle = true } }
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Cooldown = 91,
                                Ratio = 43,
                                TargetSelector = TargetSelector.BackRowEnemy,
                                Effect = "적군 3명(후열 우선) 물리 43% 3회. [귀면] 3중첩당 각 공격마다 물리 16% 추가 피해 [최대 3중첩] (귀면 스택 미모델)"
                                } },
                            { 1, new SkillLevelData {
                                TargetCount = 3,
                                AtkCount = 3,
                                ...
                                Ratio = 51,
                                TargetSelector = TargetSelector.BackRowEnemy,
                                Effect = "적군 3명(후열 우선) 물리 51% 3회. [귀면] 3중첩당 각 공격마다 물리 19% 추가 피해 (귀면 스택 미모델)"
                                } },
                            { 2, new SkillLevelData {
                                TargetCount = 3,
                                AtkCount = 3,
                                ...
                                Ratio = 51,
                                TargetSelector = TargetSelector.BackRowEnemy,
                                Effect = "각성: 적군 3명(후열 우선) 물리 51% 3회. [귀면] 3중첩당 각 공격마다 물리 19% 추가 피해 [최대 6중첩] (귀면 스택 미모델)"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                            { 2, new SkillTranscend { TargetCountOverride = 4, Effect = "대상 수 변경: 적군 4명" } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effect = "적군 3명(후열 우선): 버프해제2, 물리 43% + 대상 최대HP 6% 3회(HP비례는 시전자 공격력 100% 제한)"
                                } },
                            { 1, new SkillLevelData {
                                TargetCount = 3,
                                AtkCount = 3,
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Effect = "각성: 적군 3명(후열 우선): 버프해제2, 물리 55% + 대상 최대HP 7% 3회(HP비례는 시전자 공격력 100% 제한)"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                AtkCap = 100,
                                IgnoresTurnDamageImmunity = true,
                                Effect = "[각성 게이지 130, 미모델] 모든 적군: 물리 117% + 대상 최대HP 9% 2회(HP비례는 시전자 공격력 100% 제한). 관통(피해 무효화 무시). [귀면] 6중첩 보유 시 대상 현재HP 비례 최대 100% 피증(귀면 스택 미모델)"
                                } }
                        }
                    }
                },
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        { 0, new PassiveLevelData {
                            ...
                            Effect = "자신: 우위[2턴], 사망 시 생명력 80% 부활(전투당 1회), 적 공격 3회 적중 시 귀면 1중첩[최대6](공격형 3명 이상). 모든 아군: 물공+19%[상시]. 귀면 6중첩 시 무영비검 자동 발동(전투당 1회). 우위/귀면 스택 미모델"
                        }},
                        { 1, new PassiveLevelData {
                            MaxStacks = 6,
                            Effects = new List<PersistentEffect>
                            ...
                            Effect = "강화: 우위[3턴], 부활 시 생명력 100%, 무영비검 발동 시 물리 51%"
                        }},
                        { 2, new PassiveLevelData {
                            MaxStacks = 6,
                            Effects = new List<PersistentEffect>
                            ...
                            Effect = "각성: 자신 우위[3턴], 사망 시 생명력 100% 부활(전투당 1회)+부활 시 우위[2턴], 자신 스킬 2회 발동 시 우위 1턴 증가. 모든 아군: 물공+25%[상시]. 귀면 6중첩 시 무영비검(물리 55%+대상 최대HP 7%) 자동 발동(전투당 1회). 우위/귀면 스택 미모델"
                        }}
                    },
                    TranscendBonuses = new Dictionary<int, PassiveTranscend>
                    {
                        { 2, new PassiveTranscend { Effect = "무영비검 발동 대상 수 변경: 적군 4명" } },
                        { 6, new PassiveTranscend {
                            SelfBuff = new PermanentBuff { Wek = 100 },
                            Effect = "전투 시작 시 귀면 3중첩, 약점 공격 확률 증가 100% [상시]"
                        }}
                    }
                },
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Blind, Duration = 4 },
            ...
            new Character
            {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Ratio = 0,
                                HealAtkRatio = 250,
                                Effect = "각성게이지85 / 변신[상시]·행동제어면역(미모델), 자신 치명타피해 3중첩(16%/중첩,최대8중첩=128%), 자신 물공250% 회복. 무효화 자신[피격4회]·아군[피격2회] 증가(각 최대6)",
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Self,  Type = SkillEffectType.DamageNullification, DamageNullification = new DamageNullification { HitCount = 4, Type = DamageNullType.All } },
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.DamageNullification, DamageNullification = new DamageNullification { HitCount = 2, Type = DamageNullType.All } },
                                    new SkillEffect { Target = EffectTarget.Self,  Type = SkillEffectType.Buff, Buff = new BuffSet { Cri_Dmg = 48 } }
                                }
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effect = "대상 1명 줄 때마다 각 공격 15% 피해증가(3인60/2인90/1인120%), 자신 스킬쿨 19초 감소(미모델)"
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Ratio = 97,
                                IgnoresTurnDamageImmunity = true,
                                Effect = "모든 적군 물공 97% 2회 관통(피해면역 무시), 버프 2개 해제",
                                Effects = new List<SkillEffect>
                                {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effect = "생명력 30% 이하 즉시 처형(현재HP가 시전자 공격력 120% 초과 대상엔 무효, 미모델), 처치 시 100% 위력 연속발동"
                                } }
                        }
                    }
                },
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        ...
                        { 2, new PassiveLevelData {
                            Effect = "자신 - 모든 피해 무효화[피격 4회], 아군 - 물피증 20%[상시]. (각성 추가: 각성게이지 축적·변신 중 적 2명 사망 시 무효화[피격1회] 리필 = 미모델)",
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect {
                                    Target = EffectTarget.Party,
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Bomb, Stacks = 1, Chance = 50, Duration = 3 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.BombDetonation },
                                    // 크롤 "모든 공격력 감소" = 물공+마공 감소(적 공격 스탯), 주는피해감소(Dmg_Reduction)가 아님.
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 3, Debuff = new DebuffSet { Atk_Reduction = 13, MagicAtk_Reduction = 13 } }
                                },
                            ...
                            { 1, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Bomb, Stacks = 1, Chance = 50, Duration = 3 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.BombDetonation },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 3, Debuff = new DebuffSet { Atk_Reduction = 18, MagicAtk_Reduction = 18 } }
                                },
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.HealBlock, Duration = 4, Stacks = 1, Chance = 100 }
                                },
        ...
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                ...
                { 1, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 2, Chance = 100, PreDamage = true, Debuff = new DebuffSet { Mag_Dmg_Taken_Increase = 10 } }
                    },
                    Effect = "강화: 마법 취약 10%[100%][2턴]"
                    } },
                { 2, new SkillLevelData {
                    TargetCount = 2,
                    AtkCount = 1,
                    ...
                    Effect = "각성: 마법 70% 1회(2인), 마법취약 10%[100%][2턴]"
                    } }
            }
        },
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "마법형" }, Type = SkillEffectType.DebuffCleanse, DispelDebuffCount = 2 },
                        ...
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 3, Chance = 100, Debuff = new DebuffSet { Heal_Reduction = 48 } }
                    },
                    Effect = "아군(마법형) 디버프해제2, 침묵50%[2턴], 마법취약 대상 시 받는 회복량 48% 감소[3턴]"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 2,
                ...
                { 2, new SkillLevelData {
                    ...
                    Effect = "각성: 마법 37% 2회(5인), 침묵 60%[2턴], 마법취약 대상 시 받는 회복량 48% 감소[3턴], 아군(마법형) 디버프해제2"
                    } }
            }
        },
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effect = "턴제버프 2턴 감소[100%], 마법취약 대상 시 스킬 쿨타임 증가 19초[60%]"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 3,
                    ...
                    {
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffTurnReduction, Chance = 100, PreDamage = true, TurnReduction = 2 },
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 60, Debuff = new DebuffSet { Cooldown_Increase = 23 } }
                    },
                    Effect = "강화: 관통, 스킬 쿨타임 증가 23초"
                    } },
                { 2, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 3,
                    ...
                    Effect = "각성: 마법 26% 3회 관통(5인), 턴제버프 2턴 감소[100%], 마법취약 대상 시 스킬 쿨타임 증가 23초[70%]"
                    } }
            }
        },
        new Skill
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        ...
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.HealBlock, Chance = 100, Duration = 3 },
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Debuff = new DebuffSet { Cooldown_Increase = 26 } }
                    },
                    Effect = "각성기[각성 게이지 100]: 마법 145% 1회 관통(3인), 마법취약 대상 시 생명력 전환 39%, 회복 불가[100%][3턴], 쿨타임 증가 26초[100%]"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 3,
                    AtkCount = 1,
                    ...
                    Effect = "각성기 강화[각성 게이지 100]: 마법 155% 1회 관통(3인), 마법취약 대상 시 생명력 전환 39%, 회복 불가[100%][3턴], 쿨타임 증가 26초[100%]"
                    } }
            }
        }
    },
    Passive = new Passive
    {
        ...
        LevelData = new Dictionary<int, PassiveLevelData>
        {
            { 0, new PassiveLevelData {
                ...
                Effect = "자신 모든 피해 무효화[피격3회]. 모든 적군 효저28[상시]. 적중 시 [운명의 실][3턴](마법형 3명 이상 편성); 스킬 1회 발동 시 적 받는 보호막 52% 감소[100%][3턴]"
            }},
            { 1, new PassiveLevelData {
                Effects = new List<PersistentEffect>
                {
                ...
                Effect = "강화: 피해 무효화 4회, 받는 보호막 60% 감소"
            }},
            { 2, new PassiveLevelData {
                Effects = new List<PersistentEffect>
                {
                ...
                Effect = "각성: 피해 무효화[피격4회], 모든 적군 효저 34% 감소[상시], 스킬 1회 발동 시 받는 보호막 60% 감소[100%][3턴]"
            }}
        },
        TranscendBonuses = new Dictionary<int, PassiveTranscend>
        {
            { 2, new PassiveTranscend {
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.TriggeredHeal, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.OnHpBelow, TriggerHpThreshold = 50, MaxTriggersPerBattle = 2, TriggeredHealAtkRatio = 165 }
                },
                Effect = "생명력 50% 이하 시 마법 공격력 165% 회복 (전투당 2회)"
            }},
            { 6, new PassiveTranscend {
                Effect = "운명의 실 소모 시 모든 피해 무효화[피격 4회], 디버프 해제 3개"
            }}
        }
    },
    TranscendType = TranscendType.AtkEff
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Sleep, Stacks = 1, Chance = 40, Duration = 1 }
                                },
                                Effect = ""
                                } },
                            { 1, new SkillLevelData {
            ...
            new Character
            {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                IgnoresTurnDamageImmunity = true,
                                OnKillRecast = new OnKillRecast { RatioPercent = 100 },
                                Effect = "[각성 - 번뇌의 단죄] 방어무시 40%, 관통(피해면역 무시), 직접 피해로 처치 시 100% 위력 연속 발동 (각성으로 흡혈 삭제)"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Effect = "[각성 - 재기의 일격] 턴제 버프 감소 2턴, 방어무시 40%, 대상 최대생명력 9% 비례피해(공격력 75% 제한, 미모델)"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effect = "[각성기, 각성 게이지 120] 방어무시 40%, 버프 2개 해제(면역/무효화/권능 제외), 시전 시 자신 모든 스킬 쿨타임 초기화(미모델)"
                                } }
                        }
                    }
                },
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        ...
                        { 2, new PassiveLevelData {
                            Effect = "[각성] 축복25%, 권능(전투당1회·발동시 마법공격력135% 보호막[3턴]), 받는 회복량+36%, 스킬 1회 발동 시 마법공격력96% 회복, 행동제어 시 모든 디버프 해제→행동제어 면역[1턴](미모델), 디버프 해제 시 마법공격력+10% 1중첩(최대4, 미모델)",
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Buff, Buff = new BuffSet { Blessing = 25 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Authority, Authority = new Authority { OncePerBattle = true, ShieldAtkRatio = 135, ShieldDuration = 3 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Buff, Buff = new BuffSet { Heal_Bonus = 36 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.TriggeredHeal, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SkillOnly, TriggeredHealAtkRatio = 96 }
                            }
                        }}
                    },
                    TranscendBonuses = new Dictionary<int, PassiveTranscend>
                ...
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        { 0, new PassiveLevelData {
                            ...
                            {
                                new PersistentEffect { Target = EffectTarget.Party, Type = PersistentEffectType.Buff, Buff = new BuffSet { MagicAtk_Rate = 19 } },
                                new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.Debuff, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, OncePerBattle = true, Chance = 100, Duration = 3, Debuff = new DebuffSet { Def_Reduction = 24, Wek_Reduction = 27 } }
                            },
                        ...
                        { 1, new PassiveLevelData {
                            ...
                            {
                                new PersistentEffect { Target = EffectTarget.Party, Type = PersistentEffectType.Buff, Buff = new BuffSet { MagicAtk_Rate = 25 } },
                                new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.Debuff, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, OncePerBattle = true, Chance = 100, Duration = 3, Debuff = new DebuffSet { Def_Reduction = 34, Wek_Reduction = 27 } }
                            },
            ...
            new Character
{
        ...
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetSelector = TargetSelector.LowestHpAlly, TargetCount = 1, Type = SkillEffectType.Buff, Duration = 2, Buff = new BuffSet { Shield_HpRatio = 14 } }
                    },
                    Effect = "보호막 대상: 현재 생명력 가장 낮은 아군(자신 제외)"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 1,
                    AtkCount = 1,
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetSelector = TargetSelector.LowestHpAlly, TargetCount = 1, Type = SkillEffectType.Buff, Duration = 2, Buff = new BuffSet { Shield_HpRatio = 15 } }
                    },
                    Effect = "강화: 피해량 상승(마공 60%/최대HP 14%), 보호막 흡수량 최대HP 15%"
                    } },
                { 2, new SkillLevelData {
                    TargetCount = 1,
                    AtkCount = 1,
                    ...
                    Effect = "각성(강화): 마공 65%/최대HP 14% 피해, 보호막 최대HP 15%[2턴]"
                    } }
            }
        },
        new Skill
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        ...
                        new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Eff_Res = 28, Heal_Bonus = 22 } }
                    },
                    Effect = "피해 대상: 모든 적군. 모든 아군 지속회복[2턴]·효저28·받회증22[3턴]"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 1,
                ...
                { 2, new SkillLevelData {
                    ...
                    {
                        new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Regeneration, CustomHpRatio = 15, Duration = 3 },
                        new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Eff_Res = 37, Heal_Bonus = 28 } }
                    },
                    Effect = "각성(강화): 지속회복 15%[3턴]·효저37·받회증28[3턴]"
                    } }
            }
        },
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "공격형", "마법형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Cri_Dmg = 40 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "방어형", "지원형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Def_Rate = 31 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "만능형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Dmg_Dealt = 16, Eff_Hit = 19 } },
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 3, Debuff = new DebuffSet { Dmg_Reduction = 16 } }
                    },
                    Effect = "직업군별 버프[3턴]. 모든 적군 피해량 감소 16%[100%][3턴]"
                    } },
                { 1, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 1,
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "공격형", "마법형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Cri_Dmg = 49 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "방어형", "지원형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Def_Rate = 39 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "만능형" }, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Dmg_Dealt = 20, Eff_Hit = 19 } },
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 3, Debuff = new DebuffSet { Dmg_Reduction = 16 } }
                    },
                    Effect = "강화: 치피49·방어39·피증20"
                    } },
                { 2, new SkillLevelData {
                    TargetCount = 5,
                    AtkCount = 1,
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "공격형", "마법형" }, Type = SkillEffectType.Buff, Duration = 4, Buff = new BuffSet { Cri_Dmg = 49 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "방어형", "지원형" }, Type = SkillEffectType.Buff, Duration = 4, Buff = new BuffSet { Def_Rate = 39 } },
                        new SkillEffect { Target = EffectTarget.Party, TargetClasses = new[] { "만능형" }, Type = SkillEffectType.Buff, Duration = 4, Buff = new BuffSet { Dmg_Dealt = 20, Eff_Hit = 19 } },
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 4, Debuff = new DebuffSet { Dmg_Reduction = 16 } }
                    },
                    Effect = "각성(강화): 직업군 버프[4턴](치피49·방어39·피증20·효적19). 적 피감16[100%][4턴]"
                    } }
            },
            TranscendBonuses = new Dictionary<int, SkillTranscend>
            {
                { 6, new SkillTranscend { Effect = "6초월: 모든 직업군 버프 지속 4턴" } }
            }
        },
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                { 0, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Revive, TargetCount = 2, ReviveHpPercent = 65 }
                    },
                    Effect = "[각성 게이지 145] 사망 아군 2명 부활(공/마=불사 3턴·나머지=HP65%)+부활 시 행동제어 면역[2턴], 모든 아군 최대HP 26% 회복"
                    } }
            }
        }
    },
    Passive = new Passive
    {
        ...
        {
            { 0, new PassiveLevelData {
                Effect = "자신: 최대 생명력 비례 막기 확률 증가[상시](1000당 3%, 최대 27%), 사망 시 생명력 80% 부활(전투당 1회). 모든 적군: 모든 공격력 13% 감소[상시]. 모든 아군: 자신 스킬 발동 시 지속 회복[1턴]",
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ReviveHpPercent = 80, OncePerBattle = true } },
                    new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.Debuff, Debuff = new DebuffSet { Atk_Reduction = 13, MagicAtk_Reduction = 13 } }
                }
            }},
            { 1, new PassiveLevelData {
                Effect = "강화: 최대 생명력 비례 막기 확률 최대 증가 33%, 모든 적군 모든 공격력 16% 감소",
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ReviveHpPercent = 80, OncePerBattle = true } },
                    new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.Debuff, Debuff = new DebuffSet { Atk_Reduction = 16, MagicAtk_Reduction = 16 } }
                }
            }},
            { 2, new PassiveLevelData {
                Effect = "각성(강화): 막기 최대 33%, 사망 시 생명력 100% 부활(전투당 1회)+부활 시 모든 피해 면역[2턴](전투당 1회), 아군 역할 지원[상시]. 모든 적군 모든 공격력 16% 감소[상시]",
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ReviveHpPercent = 100, OncePerBattle = true } },
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.DamageNullification, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.OnRevival, OncePerBattle = true, DamageNullification = new DamageNullification { Duration = 2, Type = DamageNullType.All } },
                    new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.Debuff, Debuff = new DebuffSet { Atk_Reduction = 16, MagicAtk_Reduction = 16 } }
                }
            }}
        },
        TranscendBonuses = new Dictionary<int, PassiveTranscend>
        {
            { 2, new PassiveTranscend {
                ...
                Effect = "2초월: 자신 부활 시 모든 피해 면역[2턴] (전투당 1회)"
            }}
        }
    },
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 1, new SkillLevelData {
                                ...
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffDispel, DispelBuffCount = 2, Chance = 100 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 3, Debuff = new DebuffSet { Def_Reduction = 36 } }
                                },
                                Effect = ""
                                } }
                        }
            ...
            new Character
{
        ...
        new Skill
        {
            ...
            LevelData = new Dictionary<int, SkillLevelData>
            {
                ...
                { 1, new SkillLevelData {
                    ...
                    Effects = new List<SkillEffect>
                    {
                        new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Stun, Stacks = 1, Chance = 40, Duration = 1 }
                    },
                    Effect = "기절 [40% 확률] [1턴]"
                    } },
                { 2, new SkillLevelData {
        ...
        new Skill
        {
            ...
            TranscendBonuses = new Dictionary<int, SkillTranscend>
            {
                {2, new SkillTranscend {
                    ...
                    Effect = "해당 스킬로 적군 처치 시 100% 위력으로 최대 1회 연속 발동"
                }}
            }
        },
        new Skill
    ...
    Passive = new Passive
    {
        ...
        {
            { 0, new PassiveLevelData {
                Effect = "사망 시 생명력 80%로 부활(전투당 1회). 피격 1회 시 지룡의 격노 1중첩(최대30, 중첩당 주는피해+2%/물리공격력+2%). 모든 아군 막기확률+19%[상시]. 아군 전열: 자신의 스킬 1회 발동 시 시전자 물리공격력 45% 보호막[2턴]",
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ReviveHpPercent = 80, OncePerBattle = true } },
            ...
            { 1, new PassiveLevelData {
                Effect = "사망 시 생명력 100%로 부활(전투당 1회). 피격 1회 시 지룡의 격노 1중첩(최대30, 중첩당 주는피해+2%/물리공격력+2%). 모든 아군 막기확률+23%[상시]. 아군 전열: 자신의 스킬 1회 발동 시 시전자 물리공격력 45% 보호막[2턴]",
                Effects = new List<PersistentEffect>
                {
                    new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Revival, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.SelfDeath, Revival = new Revival { ReviveHpPercent = 100, OncePerBattle = true } },
        ...
        {
            { 6, new PassiveTranscend {
                Effect = "지룡의 격노 중첩당 주는피해량 증가 2%→6%, 물리공격력 증가 2%→6% (최대 30중첩)"
            }}
        }
    },
    TranscendType = TranscendType.AtkDmgRdc
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        { 0, new PassiveLevelData {
                            ...
                            Effects = new List<PersistentEffect>
                            {
                                ...
                                new PersistentEffect { Target = EffectTarget.Enemy, Type = PersistentEffectType.TriggeredFixedDamage,
                                    TriggeredFixedDamage = new TriggeredFixedDamage { TriggerCount = 2, TriggerOn = TriggerCondition.AllAttack, AtkRatio = 60, DefRatio = 65, TargetCount = 3, HitCount = 1 } }
                            }
                        }},
                        { 1, new PassiveLevelData {
                            StatScalings = new List<StatScaling>
            ...
            new Character
            {
                ...
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        { 0, new PassiveLevelData {
                            Effects = new List<PersistentEffect>
                            {
                                ...
                                // [모든 아군] 자신의 스킬 1회 발동 시 시전자 마법공 35% 회복
                                new PersistentEffect
                                {
                                    Target = EffectTarget.Party,
                                    Type = PersistentEffectType.TriggeredHeal,
                        ...
                        { 1, new PassiveLevelData {
                            Effects = new List<PersistentEffect>
                            {
                                ...
                                // [모든 아군] 자신의 스킬 1회 발동 시 시전자 마법공 55% 회복 (강화)
                                new PersistentEffect
                                {
                                    Target = EffectTarget.Party,
                                    Type = PersistentEffectType.TriggeredHeal,
                    ...
                    TranscendBonuses = new Dictionary<int, PassiveTranscend>
                    {
                        // 2초월: 아군 생명력 50% 이하 시 시전자 마법공 95% 회복 (아군별 전투당 1회)
                        { 2, new PassiveTranscend {
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Ratio = 70,
                                DefRatio = 85,
                                Effect = "각성: 자신 방어자세 1중첩[최대 4, 중첩당 방어력 +15%] (방어자세 스택은 모델 미지원)"
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffTurnReduction, Chance = 100, TurnReduction = 2 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Stun, Stacks = 1, Chance = 65, Duration = 2 }
                                },
                                TargetSelector = TargetSelector.MostBuffsEnemy,  // 버프가 많은 순
                                Effect = "각성: 대상 선정 버프가 많은 적군 / 자신 방어자세 2중첩[최대 4] (방어자세 스택은 모델 미지원)"
                                }}
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Buff, Duration = 2, Buff = new BuffSet { Dmg_Rdc = 20 } },
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.DebuffCleanse, DispelDebuffCount = 1 }
                                },
                                Effect = "각성: 모든 아군 링크[2턴, 피해 감소율 20%]+디버프 해제 1개, 방어자세 4개 소모 시 시전자 방어력 115% 생명력 회복 / 자신 방어자세 2중첩 (링크·방어자세 스택은 모델 미지원; HealDefRatio는 4스택 조건 무시하고 상시 적용됨)"
                                }}
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Dmg_Rdc = 20 } }
                                },
                                Effect = "[각성 게이지 130] 각성 전용 / 모든 적 각성 게이지 감소 10[100%](강화 시 20) / 모든 아군 링크[3턴] (각성 게이지 감소는 모델 미지원, 링크는 Dmg_Rdc 20% 근사)"
                                }}
                        }
                    }
                },
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        ...
                        { 2, new PassiveLevelData {
                            ...
                            Effect = "각성: [모든 아군] 방어력 +24%[상시] + 링크[2턴 시작] / [자신] 감쇄 20%(받피감) + 반격 38%[상시] / [아군 전열] 자신 3회 피격 시 감쇄 23%[피격 2회] / 반격 발동 시 단일 적 물리 50%+방어 60% 1회 피해 + 기절 35%[1턴] (링크·반격·전열 조건부 감쇄는 모델 미지원)"
                        }}
                    }
                },
                HasAwakening = true,
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                CleanseExplosion = new CleanseExplosion { TargetStatus = StatusEffectType.Freeze, TargetMaxHpRatio = 40, ArmorPen = 40, AtkCap = 300 },
                                Effect = "각성: 120%. 빙결[50%][1턴](해제 시 대상 최대 생명력 40% 방무 피해, 공격력 300% 제한)"
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                CleanseExplosion = new CleanseExplosion { TargetStatus = StatusEffectType.Freeze, TargetMaxHpRatio = 40, ArmorPen = 40, AtkCap = 300 },
                                Effect = "각성: 160%. 적군 3명. 빙결[75%][2턴](해제 시 대상 최대 생명력 40% 방무 피해, 공격력 300% 제한)"
                                } }
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                    ...
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.BuffTurnReduction, Chance = 100, TurnReduction = 3 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 5, Debuff = new DebuffSet { Phys_Dmg_Taken_Increase = 29 } }
                                },
                                Effect = "각성: 340%. 대상 턴제 버프 -3턴[100%]. 물리 취약 29%[100%][5턴]"
                                } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.Buff, Duration = 5, Buff = new BuffSet { Atk_Rate = 23, Cri_Dmg = 34 } }
                                },
                                Effect = "[각성 게이지 120, 미모델] 단일 적군 350%. 자신+공격력 높은 아군 2명: 물리 공격력+23%·치명타 피해+34%[5턴]"
                                } }
                        }
                    }
                },
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        ...
                        { 2, new PassiveLevelData {
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Buff, Duration = 3, Buff = new BuffSet { Atk_Rate = 31 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.DamageNullification, Duration = 2, DamageNullification = new DamageNullification { Duration = 2, Type = DamageNullType.All } },
                                // 각성 추가: 모든 아군 - 모든 공격 2회 발동 시 시전자 물리 공격력 35% 회복
                                new PersistentEffect { Target = EffectTarget.Party, Type = PersistentEffectType.TriggeredHeal, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.AllAttack, TriggerCount = 2, TriggeredHealAtkRatio = 35 }
                            },
                            Effect = "각성: 물리 공격력 +31%[상시]. 6초월 모든 피해 면역[2턴]. 모든 아군 - 모든 공격 2회 발동 시 물리 공격력 35% 회복"
                        }}
                    }
                },
                TranscendType = TranscendType.AtkCri
            ...
            new Character
            {
                ...
                Skills = new List<Skill>
                {
                    ...
                    new Skill
                    {
                        ...
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                            // 6초월: 물리 공격력 감소 25% [100% 확률] [3턴]. 적 공격 스탯 감소(생존용), 딜엔 무관.
                            { 6, new SkillTranscend {
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Duration = 3, Chance = 100, Debuff = new DebuffSet { Atk_Reduction = 25 } }
                                },
                ...
                Skills = new List<Skill>
                {
                    ...
                    new Skill
                    {
                        ...
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                            ...
                            {2, new SkillTranscend{ Bonus = new BuffSet{ }, RatioOverride = 170, DefRatioOverride = 200, Effects = new List<SkillEffect>
                            {
                                new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Stun, Stacks = 1, Chance = 100, Duration = 4 }
                            }, Effect = "2초월: 물리공 170% 방어력 200%, 기절 확률 100%" }}
                        }
                    },
                    new Skill
                    {
            ...
            new Character
            {
                ...
                Skills = new List<Skill>
                {
                    ...
                    new Skill
                    {
                        ...
                        {
                            // 2초월: 물리공 170% 방어력 200%, 기절 확률 100%
                            {2, new SkillTranscend{ RatioOverride = 170, DefRatioOverride = 200, Effects = new List<SkillEffect>
                            {
                                new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Stun, Stacks = 1, Chance = 100, Duration = 4 }
                            }, Effect = "2초월: 물리공 170% 방어력 200%, 기절 확률 100%" }}
                        }
                ...
                Skills = new List<Skill>
                {
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData { TargetCount = 1, AtkCount = 1, Ratio = 50, DefRatio = 60, Effect = "" } },
                            { 1, new SkillLevelData { TargetCount = 1, AtkCount = 1, Ratio = 60, DefRatio = 70, Effect = "" } },
                            { 2, new SkillLevelData { TargetCount = 1, AtkCount = 1, Ratio = 65, DefRatio = 75, Effect = "각성: 단일 물리공 65% + 방어력 75% 피해" } }
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                {
                                    new SkillEffect { Target = EffectTarget.Party, Type = SkillEffectType.DebuffCleanse, DispelDebuffCount = 2 },
                                    new SkillEffect { Target = EffectTarget.Enemy, Type = SkillEffectType.Debuff, Chance = 100, Duration = 3, Debuff = new DebuffSet { Wek_Reduction = 27 } }
                                },
                                Effect = "각성: 모든 적군 물리공 50% + 방어력 55% 피해, [아군] 디버프 해제 2개, [적군] 약점 공격 확률 감소 27%[100%][3턴]"
                                }}
                        },
                        TranscendBonuses = new Dictionary<int, SkillTranscend>
                        {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            ...
                            { 2, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Self, Type = SkillEffectType.DamageNullification, Duration = 3, DamageNullification = new DamageNullification { Duration = 3, Type = DamageNullType.Magic } },
                                    new SkillEffect { Target = EffectTarget.Self, Type = SkillEffectType.StatusAilment, StatusType = StatusEffectType.Taunt, Duration = 2 },
                                    new SkillEffect { Target = EffectTarget.Party, TargetCount = 3, Type = SkillEffectType.Buff, Duration = 3, Buff = new BuffSet { Mag_Dmg_Rdc = 26 } }
                                },
                                Effect = "각성: [자신] 마법 피해 면역[3턴] + 도발[2턴], [아군 3명] 마법 감쇄 26%[3턴]"
                                }}
                        }
                    },
                    new Skill
                    {
                        ...
                        LevelData = new Dictionary<int, SkillLevelData>
                        {
                            { 0, new SkillLevelData {
                                ...
                                Effects = new List<SkillEffect>
                                {
                                    new SkillEffect { Target = EffectTarget.Party, TargetCount = 3, Type = SkillEffectType.DebuffCleanse, DispelDebuffCount = 2 },
                                    new SkillEffect { Target = EffectTarget.Party, TargetCount = 3, Type = SkillEffectType.Buff, Duration = 2, Buff = new BuffSet { Shield_DefRatio = 135 } }
                                },
                                Effect = "[각성 게이지 100, 미모델] [아군 3명] 모든 디버프 해제(전체) + 스킬 쿨타임 초기화(미모델) + 시전자 방어력 135% 보호막[2턴] (강화 최종값, 기본 120%)"
                                }}
                        }
                    }
                },
                Passive = new Passive
                {
                    ...
                    LevelData = new Dictionary<int, PassiveLevelData>
                    {
                        ...
                        { 2, new PassiveLevelData {
                            Effects = new List<PersistentEffect>
                            {
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.Buff, Buff = new BuffSet { Mag_Dmg_Rdc = 24 } },
                                new PersistentEffect { Target = EffectTarget.Self, Type = PersistentEffectType.TriggeredHeal, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.OnHpBelow, TriggerHpThreshold = 50, MaxTriggersPerBattle = 2, TriggeredHealDefRatio = 138 },
                                new PersistentEffect { Target = EffectTarget.Party, TargetSelector = TargetSelector.LowestHpAlly, Type = PersistentEffectType.TriggeredHeal, ApplyMode = ApplyMode.Triggered, TriggerCondition = TriggerCondition.OnHit, TriggerCount = 3, TriggeredHealDefRatio = 40 }
                            },
                            Effect = "각성: [자신] 마법 감쇄 24%[상시] + 생명력 50%↓ 시 시전자 방어력 138% 회복(전투당 2회), [생명력 낮은 아군 2명(6초월 3명)] 자신 3회 피격당 시전자 방어력 40% 회복, [후열 만능형 2명] 방호[상시](미모델)"
                        }}
                    },
                    TranscendBonuses = new Dictionary<int, PassiveTranscend>
                    {
